...
if ! type kubectl >/dev/null 2>&1; then
	curl -o "kubectl https://amazon-eks.s3-ap-east-1.amazonaws.com/1.10.3/2018-07-26/bin/$(uname -s)/amd64/kubectl"
	chmod +x ./kubectl
...
if ! type aws-iam-authenticator >/dev/null 2>&1; then
	curl -o aws-iam-authenticator "https://amazon-eks.s3-ap-east-1.amazonaws.com/1.10.3/2018-07-26/bin/$(uname -s)/amd64/aws-iam-authenticator"
